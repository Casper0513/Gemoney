    ...
    mapper(nullptr)
{
    ...
    ui->gemoneyAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->gemoneyAtStartup);
    ...
    ui->gemoneyAtStartup->setToolTip(ui->gemoneyAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->gemoneyAtStartup->setText(ui->gemoneyAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGemoneyConfButton->setToolTip(ui->openGemoneyConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GemoneyUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gemoneyAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGemoneyConfButton_clicked()
{
