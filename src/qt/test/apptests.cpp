...
//! Entry point for GemoneyApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GemoneyApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GemoneyGUI tests.
void AppTests::guiTests(GemoneyGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GemoneyGUI::consoleShown, this, &AppTests::consoleTests);
