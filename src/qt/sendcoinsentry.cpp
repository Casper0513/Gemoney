    ...
    platformStyle(_platformStyle)
{
    ...
    // normal gemoney address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying gemoney address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &GemoneyAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
