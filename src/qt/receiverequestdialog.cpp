...
#include <config/gemoney-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGemoneyURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GemoneyUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGemoneyURI(info));
}
