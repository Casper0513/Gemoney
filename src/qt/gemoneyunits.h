...
#ifndef GEMONEY_QT_GEMONEYUNITS_H
#define GEMONEY_QT_GEMONEYUNITS_H
...
/** Gemoney unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GemoneyUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GemoneyUnits(QObject *parent);

    /** Gemoney units.
      @note Source: https://en.gemoney.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef GemoneyUnits::Unit GemoneyUnit;

#endif // GEMONEY_QT_GEMONEYUNITS_H
