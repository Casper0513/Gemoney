...
#ifndef GEMONEY_INTERFACES_NODE_H
#define GEMONEY_INTERFACES_NODE_H
...
//! Top-level interface for a gemoney node (gemoneyd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GEMONEY_INTERFACES_NODE_H
