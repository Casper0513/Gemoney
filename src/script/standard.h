...
#ifndef GEMONEY_SCRIPT_STANDARD_H
#define GEMONEY_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a gemoney address
 */
...
/**
 * Generate a Gemoney scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GEMONEY_SCRIPT_STANDARD_H
