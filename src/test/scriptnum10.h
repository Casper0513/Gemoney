...
#ifndef GEMONEY_TEST_SCRIPTNUM10_H
#define GEMONEY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gemoney Core 0.10.0, for cross-comparison.
 */
public:
