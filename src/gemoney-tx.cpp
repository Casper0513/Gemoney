...
static void SetupGemoneyTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gemoney-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gemoney-tx [options] <hex-tx> [commands]  Update hex-encoded gemoney transaction\n" +
            "or:     gemoney-tx [options] -create [commands]   Create hex-encoded gemoney transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gemoney transaction
