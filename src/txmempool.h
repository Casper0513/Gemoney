...
#ifndef GEMONEY_TXMEMPOOL_H
#define GEMONEY_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/gemoney/gemoney/pull/14193 will fix it. No known code
     * in gemoney currently depends on second guarantee, but it is important to
