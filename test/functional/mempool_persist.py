...
By default, gemoneyd will dump mempool on shutdown and
...
class MempoolPersistTest(GemoneyTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent gemoneyd from writing mempool.dat to disk. Verify that `savemempool` fails")
