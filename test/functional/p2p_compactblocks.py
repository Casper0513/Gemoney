...
# TestP2PConn: A peer we use to send messages to gemoneyd, and store responses.
...
class CompactBlocksTest(GemoneyTestFramework):
    ...
    # This test actually causes gemoneyd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gemoneyd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for gemoneyd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # gemoneyd will not send blocktxn responses for blocks whose height is
