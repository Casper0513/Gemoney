...
class SegWitTest(GemoneyTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older gemoneyd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let gemoneyd fill it in.
