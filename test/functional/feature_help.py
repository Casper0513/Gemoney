...
"""Verify that starting gemoney with -h works as expected."""

from test_framework.test_framework import GemoneyTestFramework
from test_framework.util import assert_equal

class HelpTest(GemoneyTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gemoney with -h for help text")
        ...
        self.log.info("Start gemoney with -version for version information")
        ...
        self.log.info("Start gemoneyd with -fakearg to make sure it does not start")
