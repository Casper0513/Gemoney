...
// gemoney includes.
#include <..\src\script\gemoneyconsensus.h>
...
int main()
{
    std::cout << "gemoneyconsensus version: " << gemoneyconsensus_version() << std::endl;
    ...
    auto op0Result = gemoneyconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, gemoneyconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
