Gemoney Core version *0.15.2* is now available from:

  <https://gemoneycore.org/bin/gemoney-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in gemoney-tx (TheBlueMatt)
