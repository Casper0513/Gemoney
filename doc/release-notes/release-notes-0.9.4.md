Gemoney Core version 0.9.4 is now available from:

  https://gemoney.org/bin/0.9.4/
...
this update is incompatible with the Gemoney system and could lead to consensus
forks.

Gemoney Core released binaries from https://gemoney.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~gemoney/+archive/ubuntu/gemoney
- A third-party or self-compiled Gemoney Core

upgrade to Gemoney Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
