Gemoney Core version 0.16.1 is now available from:

  <https://gemoneycore.org/bin/gemoney-core-0.16.1/>
...
- #12843 `df38b13` Test starting gemoneyd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure gemoneyd processes are cleaned up when tests end (sdaftuar)
