Gemoney Core version 0.10.3 is now available from:

  <https://gemoney.org/bin/gemoney-core-0.10.3/>
...
(see https://github.com/gemoney/gemoney/pull/6793, as well as the 0.11.0
