Gemoney version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gemoney/files/Gemoney/gemoney-0.5.4/
...
http://gitorious.org/gemoney/gemoneyd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gemoney-Qt notifications under Growl 1.3.
Increase required age of Gemoney-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGemoney properly when installing Gemoney-Qt over it. (Windows)
