Gemoney-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gemoney/files/Gemoney/gemoney-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gemoney
...
New/changed settings (command-line or gemoney.conf file)
--------------------------------------------------------
