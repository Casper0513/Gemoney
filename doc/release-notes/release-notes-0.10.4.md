Gemoney Core version 0.10.4 is now available from:

  <https://gemoney.org/bin/gemoney-core-0.10.4/>
...
- #6953 `43c2789` Split gemoney-tx into its own package
- #6953 `dfe0d4d` Include gemoney-tx binary on Debian/Ubuntu
