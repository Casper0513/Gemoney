Gemoney Core version 0.13.2 is now available from:

  <https://gemoney.org/bin/gemoney-core-0.13.2/>
...
- #8908 `4a974b2` Update gemoney-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow gemoney-tx to create v2 transactions (btcdrak)
