...
This document provides guidelines for internationalization of the Gemoney Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gemoney_en.ts` remains unchanged.
